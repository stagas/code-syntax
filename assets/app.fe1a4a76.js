const e=`<a href="https://github.com/stagas/code-syntax" title="code-syntax on GitHub" target="_blank">
...
<h2>license:</h2>
<h3>MIT</h3>
`,n=[{level:"2",content:"installation:"},{level:"2",content:"create your own syntax!"},{level:"2",content:"how to use:"},{level:"3",content:"result:"},{level:"2",content:"API"},{level:"4",content:"Table of Contents"},{level:"3",content:"CodeSyntaxElement"},{level:"3",content:"compile"},{level:"4",content:"Parameters"},{level:"3",content:"syntax"},{level:"4",content:"Parameters"},{level:"2",content:"license:"},{level:"3",content:"MIT"}],t=()=>({html:e,toc:n});export{t as createApp};
